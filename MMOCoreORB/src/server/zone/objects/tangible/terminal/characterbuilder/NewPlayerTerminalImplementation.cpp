...
void NewPlayerTerminalImplementation::loadTemplateData(SharedObjectTemplate* templateData) {
	TangibleObjectImplementation::loadTemplateData(templateData);

	NewPlayerTerminalTemplate* terminalData = dynamic_cast<NewPlayerTerminalTemplate*>(templateData);
...
void NewPlayerTerminalImplementation::initializeTransientMembers() {
	TerminalImplementation::initializeTransientMembers();

	setLoggingName("NewPlayerTerminal");
}

int NewPlayerTerminalImplementation::handleObjectMenuSelect(CreatureObject* player, byte selectedID) {
...
void NewPlayerTerminalImplementation::sendInitialChoices(CreatureObject* player) {
	if (!ConfigManager::instance()->getCharacterBuilderEnabled())
		return;
	...
	ManagedReference<SuiNewPlayerBox*> sui = new SuiNewPlayerBox(player, rootNode);
...
void NewPlayerTerminalImplementation::enhanceCharacterNew(CreatureObject* player) {
...
void NewPlayerTerminalImplementation::grantGlowyBadges(CreatureObject* player) {
	NewPlayerTerminalTemplate* terminalTemplate = dynamic_cast<NewPlayerTerminalTemplate*>(templateObject.get());
...
void NewPlayerTerminalImplementation::grantJediInitiate(CreatureObject* player) {
...
void NewPlayerTerminalImplementation::giveDnaTestingSet(CreatureObject* player, const String& testName) {
	if (player == nullptr)
		return;
...
void NewPlayerTerminalImplementation::readDnaTable(LuaObject* dnaSetTable, CreatureObject* player, const String& testName) {
