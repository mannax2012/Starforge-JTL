/*
 * SuiNewPlayerBoxImplementation.cpp
 *
...
BaseMessage* SuiNewPlayerBoxImplementation::generateMessage() {
...
const NewPlayerMenuNode* SuiNewPlayerBoxImplementation::getCurrentNode() {
	return currentNode;
}

void SuiNewPlayerBoxImplementation::setCurrentNode(const NewPlayerMenuNode* node) {
	currentNode = node;
}
