...
function SkillTrainer:getMeleeBountyHunterTrainerSkills()
	...
	local candidateSkills = {
		...
		"combat_melee_bountyhunter_twohanded_grips_01",
		"combat_melee_bountyhunter_twohanded_grips_02",
		"combat_melee_bountyhunter_twohanded_grips_03",
		"combat_melee_bountyhunter_twohanded_grips_04",
		...
		"combat_melee_bountyhunter_defensive_01",
		"combat_melee_bountyhunter_defensive_02",
		"combat_melee_bountyhunter_defensive_03",
		"combat_melee_bountyhunter_defensive_04",
