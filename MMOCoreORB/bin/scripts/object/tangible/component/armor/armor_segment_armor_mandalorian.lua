...
object_tangible_component_armor_armor_segment_armor_mandalorian = object_tangible_component_armor_shared_armor_segment_armor_mandalorian:new {
	...
	-- armor_special_type: energy (2) + lightsaber (16) = 18.
	experimentalMin = {0, 0, 1000, 1, 100, 0, 0, 0, 1, 18, 1, 100},
	experimentalMax = {0, 0, 1000, 20, 1000, 0, 0, 0, 1, 18, 25, 1000},
	experimentalPrecision = {0, 0, 0, 12, 0, 0, 0, 0, 0, 0, 10, 0},
	experimentalCombineType = {0, 0, 1, 1, 1, 1, 1, 1, 4, 4, 4, 1},
}

ObjectTemplates:addTemplate(object_tangible_component_armor_armor_segment_armor_mandalorian, "object/tangible/component/armor/armor_segment_armor_mandalorian.iff")