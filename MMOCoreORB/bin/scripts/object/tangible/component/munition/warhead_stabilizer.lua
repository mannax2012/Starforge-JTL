...
object_tangible_component_munition_warhead_stabilizer = object_tangible_component_munition_shared_warhead_stabilizer:new {
	...
	experimentalMin = {0, 0, 0, 0, 1, 0, 1000, -5, -5, -5, 0, 0, 0},
