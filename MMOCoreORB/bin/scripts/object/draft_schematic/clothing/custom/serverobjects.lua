...
-- Tusken
includeFile("draft_schematic/clothing/custom/clothing_gloves_tusken_raider_schematic.lua")

includeFile("draft_schematic/clothing/custom/clothing_belt_tusken_raider_schematic.lua")

includeFile("draft_schematic/clothing/custom/clothing_boots_tusken_raider_schematic.lua")

includeFile("draft_schematic/clothing/custom/clothing_hat_tusken_raider_schematic.lua")
...
includeFile("draft_schematic/clothing/custom/clothing_bandolier_tusken_raider_s03_schematic.lua")

includeFile("draft_schematic/clothing/custom/clothing_bracer_tusken_raider_l_schematic.lua")
includeFile("draft_schematic/clothing/custom/clothing_bracer_tusken_raider_r_schematic.lua")