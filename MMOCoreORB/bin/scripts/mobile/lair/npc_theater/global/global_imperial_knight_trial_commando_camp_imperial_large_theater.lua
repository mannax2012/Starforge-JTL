global_imperial_knight_trial_commando_camp_imperial_large_theater = Lair:new {
	mobiles = {
		{"storm_commando", 12},
		{"stormtrooper", 3}
	},
...
addLairTemplate("global_imperial_knight_trial_commando_camp_imperial_large_theater", global_imperial_knight_trial_commando_camp_imperial_large_theater)
