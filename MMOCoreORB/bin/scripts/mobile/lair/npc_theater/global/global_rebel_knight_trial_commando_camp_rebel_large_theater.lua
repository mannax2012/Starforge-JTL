global_rebel_knight_trial_commando_camp_rebel_large_theater = Lair:new {
	mobiles = {
		{"rebel_commando", 12},
		{"rebel_trooper", 3}
	},
...
addLairTemplate("global_rebel_knight_trial_commando_camp_rebel_large_theater", global_rebel_knight_trial_commando_camp_rebel_large_theater)
