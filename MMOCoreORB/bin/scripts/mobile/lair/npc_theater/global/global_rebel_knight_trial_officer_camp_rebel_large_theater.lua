global_rebel_knight_trial_officer_camp_rebel_large_theater = Lair:new {
	mobiles = {
		{"rebel_commando", 5},
		{"rebel_trooper", 5}
	},
...
addLairTemplate("global_rebel_knight_trial_officer_camp_rebel_large_theater", global_rebel_knight_trial_officer_camp_rebel_large_theater)
