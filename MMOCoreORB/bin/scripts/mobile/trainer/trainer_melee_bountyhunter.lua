trainer_melee_bountyhunter = Creature:new {
	objectName = "@mob/creature_names:trainer_melee_bountyhunter",
...
CreatureTemplates:addCreatureTemplate(trainer_melee_bountyhunter, "trainer_melee_bountyhunter")
